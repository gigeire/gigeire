...
- Name: Analytics Page >> should display monthly earnings chart with year toggles
- Location: /Users/Lenchman/gigeire/tests/analytics.spec.ts:65:7
...
Call log:
  ...
  - waiting for locator('h1:has-text("Analytics")')
    ...
    at /Users/Lenchman/gigeire/tests/analytics.spec.ts:67:60
```
