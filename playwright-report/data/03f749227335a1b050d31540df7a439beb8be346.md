...
- Name: Analytics Page >> should display booking funnel chart with year toggles
- Location: /Users/Lenchman/gigeire/tests/analytics.spec.ts:36:7
...
Call log:
  ...
  - waiting for locator('h1:has-text("Analytics")')
    ...
    at /Users/Lenchman/gigeire/tests/analytics.spec.ts:38:60
```
