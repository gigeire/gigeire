...
- Name: Analytics Page >> should display payment timing chart with summary stats
- Location: /Users/Lenchman/gigeire/tests/analytics.spec.ts:118:7
...
Call log:
  ...
  - waiting for locator('h1:has-text("Analytics")')
    ...
    at /Users/Lenchman/gigeire/tests/analytics.spec.ts:120:60
```
