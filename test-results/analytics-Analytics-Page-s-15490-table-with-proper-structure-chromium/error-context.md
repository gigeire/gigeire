...
- Name: Analytics Page >> should display top clients table with proper structure
- Location: /Users/Lenchman/gigeire/tests/analytics.spec.ts:87:7
...
Call log:
  ...
  - waiting for locator('h1:has-text("Analytics")')
    ...
    at /Users/Lenchman/gigeire/tests/analytics.spec.ts:89:60
```
