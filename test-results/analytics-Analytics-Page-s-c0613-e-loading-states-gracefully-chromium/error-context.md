...
- Name: Analytics Page >> should handle loading states gracefully
- Location: /Users/Lenchman/gigeire/tests/analytics.spec.ts:152:7
...
Call log:
  ...
  - waiting for locator('h1:has-text("Analytics")')
    ...
    at /Users/Lenchman/gigeire/tests/analytics.spec.ts:165:60
```
